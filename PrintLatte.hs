...
instance Print AbsLatte.Program where
  prt i e = case e of
    AbsLatte.Prg stmts -> prPrec i 0 (concatD [prt 0 stmts])

instance Print AbsLatte.Block where
  prt i e = case e of
    AbsLatte.Blck stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])
...
instance Print AbsLatte.Stmt where
  prt i e = case e of
    ...
    AbsLatte.FDecl type_ id args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    ...
    AbsLatte.Cond expr block -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    AbsLatte.CondElse expr block1 block2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    AbsLatte.While expr block -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    AbsLatte.SExp expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])
    AbsLatte.Print expr -> prPrec i 0 (concatD [doc (showString "print"), prt 0 expr, doc (showString ";")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]

instance Print AbsLatte.Arg where
  prt i e = case e of
    AbsLatte.ArgVal type_ id -> prPrec i 0 (concatD [prt 0 type_, prt 0 id])
    AbsLatte.ArgRef type_ id -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&"), prt 0 id])
  prtList _ [] = concatD []
...
instance Print AbsLatte.Type where
  prt i e = case e of
    AbsLatte.ArgTypeP ptype -> prPrec i 0 (concatD [prt 0 ptype])
    AbsLatte.VoidType vtype -> prPrec i 0 (concatD [prt 0 vtype])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]

instance Print AbsLatte.PType where
  prt i e = case e of
    AbsLatte.Integer -> prPrec i 0 (concatD [doc (showString "int")])
    AbsLatte.String -> prPrec i 0 (concatD [doc (showString "string")])
    AbsLatte.Bool -> prPrec i 0 (concatD [doc (showString "bool")])

instance Print AbsLatte.VType where
  prt i e = case e of
